...
//  testFrame
//
//  Created by xianhuanlin on 2018/1/3.
...
@implementation wtsBarButton

@end

@implementation navhandler
        ...
        withContainer:(UIViewController *)container
{
    if (param[@"title"]) {
        ...
        wtsBarButton *button = [wtsBarButton buttonWithType:UIButtonTypeRoundedRect];
...
{
    wtsBarButton *button = (wtsBarButton *)sender;
